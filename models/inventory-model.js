 ...
 * ************************** */
async function getInventoryByInvId(classification_id) {
  try {
    const data = await pool.query(
...
module.exports = {getClassifications, getInventoryByClassificationId, getInventoryByInvId, registerClass, registerInv, checkExistingClass};